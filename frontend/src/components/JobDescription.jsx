...
const JobDescription = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            ...
            <p className='border-b-2 border-b-gray-300 font-medium py-4'>Job Description</p>
            <div className='my-4'>
                ...
                <p className='font-bold my-1'>Experience: <span className='pl-4 font-normal text-gray-800'>{singleJob?.experience} yrs</span></p>
