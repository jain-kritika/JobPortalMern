  ...
  return (
    <div>
      ...
      <div className='flex items-center justify-center max-w-7xl mx-auto'>
        <form onSubmit={submitHandler} className='w-full sm:w-1/2 md:w-2/3 lg:w-1/2 border border-gray-200 rounded-md p-4 my-10'>
            ...
            <RadioGroup className="flex items-center gap-4 my-5">
              <div className="flex items-center space-x-2">
                <Input
                  ...
                  onChange={changeEventHandler} // Handle radio selection
